            ...
            <div>
              ...
              <div className="mt-2.5">
                <input
                  ...
                  className="block w-full rounded-md border-0 px-3.5 py-2 text-sm leading-6 shadow-sm ring-1 ring-inset ring-zinc-300 placeholder:text-zinc-400 focus:ring-2 focus:ring-inset focus:ring-zinc-900 dark:bg-zinc-900 dark:focus:ring-white"
                />
              </div>
            </div>
            <div>
              ...
              <div className="relative mt-2.5">
                <div className="absolute inset-y-0 left-0 flex items-center">
                  ...
                  <select
                    id="country"
                    name="country"
                    className="h-full rounded-md border-0 bg-transparent bg-none py-0 pl-4 pr-9 text-sm text-zinc-400 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-zinc-900 dark:focus:ring-white"
                  >
                    <option>US</option>
                    <option>CA</option>
                    <option>EU</option>
                ...
                <input
                  ...
                  id="phone-number"
                  autoComplete="tel"
                  className="block w-full rounded-md border-0 px-3.5 py-2 pl-20 text-sm leading-6 shadow-sm ring-1 ring-inset ring-zinc-300 placeholder:text-zinc-400 focus:ring-2 focus:ring-inset focus:ring-zinc-900 dark:bg-zinc-900 dark:focus:ring-white"
                />
              </div>
            </div>
            <div className="sm:col-span-2">
